...
void modify_products(item buy_items[],int size_of_buy_items)  //to modify the availability of products
{
    ...
    item array[50];                            // to store the items available
...
{
    char str[200];
    printf(BOLD WHITE"________________________________________________________________________________________________________________");
    ...
    char ch,password[10],q[10]="sanskruti";
